    ...
    <div className="flex justify-center  px-4 py-6 ">
      <div className="w-[360px] min-h-[647px] border-2 border-gray-800 rounded-2xl p-4 flex flex-col gap-6">
        ...
        <div className="flex flex-col mt-4 gap-5" >
          ...
          <select onChange={handleLanguagesChange} className="border border-gray-800 rounded">
           {languages.map((lang)=>(
          ...
          <button 
                className="w-full bg-[#035A9D] text-white font-bold text-xl py-2 rounded-xl mt-auto -mb-30 hover:bg-blue-800 text-[24px]"
                onClick={onChat}
                >
            Chat with Polly
          </button>
